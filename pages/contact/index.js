        ...
        <form>
          <div className="w-4/5">
            <input
              ...
              name="name"
              id="name"
              className="mb-3 w-full rounded-md border border-secondary-light bg-primary-dark px-4 py-1 placeholder:text-secondary-light focus:border-primary-light focus:outline-none"
              placeholder="Name"
            />
            <input
              type="email"
            ...
            <textarea
              name="email"
              id="email"
              className="mb-2 h-40 w-full rounded-md border border-secondary-light bg-primary-dark px-4 py-1 placeholder:text-secondary-light focus:border-primary-light focus:outline-none"
