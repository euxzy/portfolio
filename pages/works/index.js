        ...
        <section className="relative flex h-[450vh] items-center justify-center">
          ...
          <div className="fixed left-1/2 top-[30%] flex md:left-1/4" ref={ref}>
            {Projects.map((project) => (
              <div key={project.id}>
                <motion.div {...AnimationCard} className="mx-12 flex w-72 flex-col items-center justify-center rounded-md border-4 border-primary-light bg-primary-light p-[2px]">
