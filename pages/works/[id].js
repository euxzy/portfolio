...
import { AnimationContent } from '../../components/Animations';
  ...
  return (
    <Layouts pageTitle=" | Works">
      <section className="relative flex w-full items-center justify-center py-40 md:h-screen">
        ...
        <motion.div {...AnimationContent} className="relative flex w-72 flex-col rounded-xl bg-primary-light p-2 md:w-3/4 md:flex-row md:justify-between">
          {id != undefined ? (
            <>
